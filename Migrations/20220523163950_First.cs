        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameFilter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FilterDiagonal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FilterColor = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Monitor_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetail_Monitor_MonitorID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopCartItem_Monitor_MonitorId",
                        column: x => x.MonitorId,
                        principalTable: "Monitor",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ce25a02e-f066-4bc8-a95c-61cc2deb240a", "4d5c8257-12d7-4df6-81d1-5a389c184879" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopCartItem_MonitorId",
                table: "ShopCartItem",
                column: "MonitorId");
        }
